...
while ($i -lt $inputNums.Count)
{
    switch ($numRemainingChildNodes)
    {
        ...
        0 { # no more childnodes, Slice out this node's metadata numbers, and jump $i past it.
        ...
        default  # any number of nodes still at this level, launch the start of a node into the stack.
        {       
            $stack.Push(@{
